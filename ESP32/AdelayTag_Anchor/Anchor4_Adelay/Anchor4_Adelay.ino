...
// MAC Address ของ Anchor 4 (เปลี่ยนจาก 01 เป็น 04)
char anchor_addr[] = "84:00:00:00:00:00:00:04";
...
void setup() {
  Serial.begin(115200);
  delay(1000);
  // เปลี่ยนข้อความเพื่อแสดงว่าเป็น Anchor 4
  Serial.println("\n=== ANCHOR 4 CALIBRATION MODE ===");
