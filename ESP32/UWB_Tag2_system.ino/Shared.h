...
// =================== FIELD CONSTANTS ===================
static constexpr float FIELD_W = 2.00f; // แก้เป็น 2.00 (ระยะ A1 -> A2)
static constexpr float FIELD_H = 3.00f; // แก้เป็น 3.00 (ระยะ A1 -> A3)
...
// [Tuning 1] ยอมรับการกระโดดของค่าได้มากขึ้น (กันค่าหลุดเวลาสัญญาณสะท้อน)
...
// =================== POSITION GATING ===================
// [Tuning 2] ขยายประตู RMSE ให้กว้างขึ้น (1 เมตร) เพื่อยอมรับค่าที่เพี้ยนนิดหน่อยได้ ดีกว่าเตะเสาทิ้ง
static constexpr float RMSE_GATE_M = 1.00f; 
static constexpr float RMSE_HARD_M = 2.00f; // ขยาย Hard Gate ตาม
static constexpr float MAX_STEP_M = 0.50f;  

// =================== TIMING ===================
// [Tuning 3] เพิ่มเวลา Timeout เป็น 15 วินาที (ถ้าเสาหายไปแป๊บเดียว ให้ถือว่ายังอยู่)
static constexpr uint32_t ANCHOR_TIMEOUT_MS = 15000;
